#!/bin/bash
# This script is taken from https://scihub.copernicus.eu/userguide/BatchScripting without any modification.
...
export USERNAME="gsaltintas"
export PASSWORD="pA2469%78HAx"
export TIME_SUBQUERY=""
export PRODUCT_TYPE=""
export INGEGESTION_TIME_FROM="1970-01-01T00:00:00.000Z"
export INGEGESTION_TIME_TO="NOW"
export SENSING_TIME_FROM="2022-01-01T00:00:00.000Z"
