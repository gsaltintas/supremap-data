...
parser.add_argument('--id', help='Specify Swisstopo id', default=None)
parser.add_argument('--csv_paths', help='Provide a csv file for bulk download of specific files.', default=None, nargs='*')

parser.add_argument('--rows', help='Rows to query for in the Sentinel API, max 100', type=int, default=20)
parser.add_argument('--max_rows', help='Maximum number of rows to query.', type=int, default=20000)
